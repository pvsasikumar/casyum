...
export const ResetPassword: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      await api.resetPassword(emailParam, token, newPassword, confirmPassword);
      setIsSuccess(true);
      setTimeout(() => {
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <div className="flex flex-col">
            <h3 className="text-lg font-bold font-display text-white tracking-tight">
              Reset <span className="text-violet-400">Password</span>
            </h3>
        ...
        {isSuccess && (
          ...
          >
            ...
            <div>
              <span className="text-sm font-bold text-emerald-300">Password reset successful!</span>
              <span className="text-xs text-emerald-400/80 block mt-1">Redirecting to login page...</span>
            </div>
          </motion.div>
        )}
        ...
        {!isSuccess && (
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <p className="text-xs text-white/40 leading-relaxed">
              Enter your new password for <span className="text-violet-400 font-medium">{emailParam}</span>
            </p>
