...
export function AnimeNavBar({ items, className, defaultActive = "Home", onTabChange }: NavBarProps) {
  ...
  return (
    <div className={cn("flex justify-center pt-16 overflow-visible", className)}>
      <motion.div
        className="flex items-center gap-3 bg-black/50 border border-white/10 backdrop-blur-lg py-2 px-2 rounded-full shadow-lg relative overflow-visible"
            ...
            >
              ...
              {isActive && (
                ...
                >
                  ...
                  <div className="absolute inset-[-4px] bg-violet-500/20 rounded-full blur-xl" />
                  <div className="absolute inset-[-8px] bg-violet-500/15 rounded-full blur-2xl" />
                  <div className="absolute inset-[-12px] bg-violet-500/5 rounded-full blur-3xl" />
                  <div
              ...
              {/* Floating anime mascot on active tab */}
              {isActive && (
                <motion.div
