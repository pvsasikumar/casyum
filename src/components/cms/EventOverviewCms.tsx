...
import { loadEventCms, saveEventCms } from './eventCmsService';
...
export const EventOverviewCms: React.FC<EventOverviewCmsProps> = ({
  ...
  const persist = useCallback(async () => {
    ...
    setSaveState('saving');
    try {
      const saved = await saveEventCms(eventId, snapshot, editor || { id: 'editor', name: 'Editor', role: 'Editor' });
      setData(saved);
