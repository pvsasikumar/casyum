...
function mapAssignedEvent(ev: any): EventItem {
  return {
    ...
    revenue: 0,
    rules: [],
    teamEvent: ev.team_event === true,
    minTeamSize: Number(ev.min_team_size) || 0,
    maxTeamSize: Number(ev.max_team_size) || 0,
    teamFormationEnabled: ev.team_formation_enabled === true,
    feeType: ev.fee_type || 'Per Participant',
