...
import { Search, Loader2, UserCheck, CheckCircle2, XCircle, TrendingUp } from 'lucide-react';
import { useObserver } from '../context/ObserverContext';
import { ReadOnlyBadge } from '../components/ReadOnlyBanner';

export const AttendancePage: React.FC = () => {
  const { events, registrations, attendance, attendanceLoading } = useObserver();
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col gap-6 select-none pb-16">
      <div className="flex flex-col gap-1.5">
        ...
        <p className="text-[11px] text-white/50">
          {totals.eligible} eligible · {totals.present} present · {totals.absent} absent · {totals.marked} marked
        </p>
      </div>
